...
const Details = ({ tagline, poster, overview, vote_average, release_date, type,genres, runtime }) => {
  return ( 
    <Flex alignItems='flex-start' pt={['0px','0px','20px','0px','120px']} pb='40px' direction={['column-reverse','column-reverse','row']} px={['','','','0px','90px']} gap={['0','0','80px']}>
          <Box w={['','','','','480px']} h={['','','','720px']} mt={['20px','20px','0']} as={motion.div} initial={{ opacity: 0, x: -60 }} whileInView={{ opacity: 1, x: 0, transition: {duration: 1,}}} viewport={{ once: true }}>
          ...
          <Box w={['','','480px']} as={motion.div} initial={{ opacity: 0, x: 60 }} whileInView={{ opacity: 1, x: 0, transition: {duration: 1, delay: .25}}} viewport={{ once: true }} >
            ...
            <Tag h='40px' top='10px'
              px='8px'borderRadius='8px' mt='24px'fontWe ight='400' bgColor='#000000A6' color='#FFAD49'
              _hover={{
                  bgColor: 'white',
                  fontWeight: '900',
                  color:'#FFAD02'
